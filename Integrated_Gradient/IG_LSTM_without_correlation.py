...
def process_dataset_with_IG_lstm_without_corr(path, prepare_data_func):
    ...
    csv_output_path = f"output/FI_Dataframes/Integrated_Gradients/{dataset_name}_IG_lstm_without_corr.csv"
    os.makedirs(os.path.dirname(csv_output_path), exist_ok=True)
    importance_df.to_csv(csv_output_path, index=False)

    # Plot feature importance
    plot_path = f"output/FI_Plots/Integrated_Gradients/{dataset_name}_IG_lstm_without_corr.png"
