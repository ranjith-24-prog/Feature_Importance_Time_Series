...
def process_dataset_with_integrated_gradients_withcorr_without_redudancy(path, prepare_data_func):
    # Prepare data
    ...
    csv_output_path = f"output/FI_Dataframes/Integrated_Gradients/{dataset_name}_IG_withcorr_without_redudancy.csv"
    os.makedirs(os.path.dirname(csv_output_path), exist_ok=True)
    importance_df.to_csv(csv_output_path, index=False)

    # Plot feature importance
    plot_path = f"output/FI_Plots/Integrated_Gradients/{dataset_name}_IG_withcorr_without_redudancy.png"
