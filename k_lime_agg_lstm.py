...
from prepare_data import prepare_data_with_correlation_without_redundancy, get_all_features,prepare_data_with_correlation
...
X, y, feature_names = prepare_data_with_correlation_without_redundancy('static/Dataset/DMC2_AL_CP2.csv')
