...
explainer = LimeTabularExplainer(X_train, mode='regression', feature_names=retained_features)
...
feature_importance = {retained_features[i]: abs(importance) for i, importance in feature_importance_dict.items()}
