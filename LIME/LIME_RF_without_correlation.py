...
def process_dataset_with_lime_agg_rf_without_corr(path, prepare_data_func):
    ...
    csv_output_path = f"output/FI_Dataframes/LIME/{dataset_name}_lime_rf_without_corr.csv"
    ...
    plot_path = f"output/FI_Plots/LIME/{dataset_name}_lime_rf_without_corr.png"
