...
def process_dataset_with_winit_lstm_vae_with_corr(path, prepare_data_func):
    ...
    csv_output_path = f"output/FI_Dataframes/WinIT/{dataset_name}_WinIT_lstm_With_Corr_vae_without_redundancy.csv"
    ...
    plot_path = f"output/FI_Plots/WinIT/{dataset_name}_WinIT_lstm_With_Corr_vae_without_redundancy.png"
