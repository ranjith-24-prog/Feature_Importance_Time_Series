...
from prepare_data_new import prepare_data_without_correlation, get_all_features
import os



# Prepare the data
X, y = prepare_data_without_correlation()
...
csv_output_path = f"output/FI_Dataframes/Permutation/PI_RF_withoutcorr.csv"
...
plot_path = f"output/FI_Plots/Permutation/PI_RF_withoutcorr.png"
