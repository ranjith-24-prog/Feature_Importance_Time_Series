...
def process_dataset_with_winit_lstm_without_corr(path, prepare_data_func):
    # Prepare data
    ...
    csv_output_path = f"output/FI_Dataframes/WinIT/{dataset_name}_WinIT_LSTM_without_corr.csv"
    os.makedirs(os.path.dirname(csv_output_path), exist_ok=True)
    importance_df.to_csv(csv_output_path, index=False)

    # Plot feature importance
    plot_path = f"output/FI_Plots/WinIT/{dataset_name}_WinIT_LSTM_without_corr.png"
