...
def process_dataset_with_PI_DT(path, prepare_data_func):
    # Prepare the data
    ...
    csv_output_path = f"output/FI_Dataframes/Permutation/{dataset_name}_PI_DT_withcorr.csv"
    ...
    plot_path = f"output/FI_Plots/Permutation/{dataset_name}_PI_DT_withcorr.png"
